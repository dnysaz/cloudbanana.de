...
ExecStart=$INSTALL_DIR/venv/bin/uvicorn app.main:app --host 127.0.0.1 --port 8001 --workers 1 --limit-max-requests 10000 --timeout-keep-alive 30 --backlog 2048 --timeout-graceful-shutdown 15
Restart=always
RestartSec=3
